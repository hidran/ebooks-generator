...
## Kept in English in all editions
...
| token | il token (m.) | el token (m.) |
| embedding | l'embedding (m.) | el embedding (m.) |
| chunk | il chunk (m.) | el chunk (m.) |
| checkpoint | il checkpoint (m.) | el checkpoint (m.) |
| provider | il provider (m.) | el provider (m.) |
| toolkit | il toolkit (m.) | el toolkit (m.) |
...
| pre-processor / post-processor | pre-processor / post-processor | pre-processor / post-processor |
